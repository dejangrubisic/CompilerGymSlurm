...
# python launcher/slurm_launch.py --app=rllib_agent.py --time=10:00:00 -nc=80 -ng=2 --iter=0  --dataset=mm64_256_16_range  --trainer=dqn.ApexTrainer --steps=10  --eval_size=25 --eval_time=60 --wandb_url=dejang/loop_tool_agent_split/3be38_00000
